...
I used the Hampell technique. In essence, I take the median of neighbouring data points from a local argument (example, 5 neighbours on each side) and then check the standard deviation. Something like, take every point in the window, find how far it is from the median, then take the median of those distances. It uses the standard scaling constant for M.A.D. (1.4826)
